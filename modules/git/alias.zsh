...
if ! zstyle -t ':prezto:module:git:alias' skip 'yes'; then
  ...
  # Log (l)
  alias glc='git log --topo-order --pretty=format:"${_git_log_medium_format}"'
  ...
  alias glcc='git shortlog --summary --numbered'
  ...
  alias gwss='emacsclient -e "(magit-status)"'
